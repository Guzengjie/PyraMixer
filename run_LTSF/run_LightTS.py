...
parser.add_argument('--subseq_len', type=list, default=sub_seq, help='下采样的最短长度')
...
parser.add_argument('--h_fs', type=int, default={24: 60, 18: 60, 9: 24, 6: 24}, help='基于下采样的最短长度，将序列划分的份数')
...
new_d_model = 64
sum_seq_len = {24: [48, 24, 12, 6], 96: [48, 48, 48], 36: [18, 18, 18, 18], 192: [48, 12, 6], 336: [48, 12], 720: [48, 24, 12, 6]}
...
data_parser = {
                ...
                'ER': {'data': 'ER.csv', 'T': 'OT', 'M': [8, 8, 8], 'S': [1, 1, 1], 'MS': [8, 8, 1], 'idl': [0], 'hfs':[13, 13], 'k_of_pyramid':[2, 3, 4], 'p_of_pyramid':[3, 3, 3], 'norm':[1], 'ln':[0], 'snet_act': [1], 'ar':[1], 'fft':[False], 'freq':['d']},
                ...
                'idl': [0], 'hfs': [49, 37, 1], 'k_of_pyramid':[1, 2, 3, 4], 'p_of_pyramid':[48, 36, 24, 12], 'norm': [1], 'ln': [0], 'snet_act': [1], 'ar':[1], 'fft':[False], 'freq':['7d']},
}
    ...
    for x1 in range(len(all_task['dataset_name'])):
        for x2 in range(len(all_task['pre_len'])):
            ...
            if args.data in data_parser.keys():
                ...
                args.freq_dim = data_info2['fre_dim']
            ...
            if args.is_training:
                ...
                for ii in range(exp_num):
                    ...
                    if modelname in all_name_of_LRSNet:
                        ...
                        for nn in range(len(args.k_of_pyramid)):
                            ...
                            str_sub_len += str(args.subseq_len[nn])
                        setting += '_' + str_sub_len
                        setting += '_' + str_k
                        setting += '_' + str_p
                    elif modelname == 'DLinear':
                        setting = '{}_{}_{}_sl{}_pl{}_CI{}_seed{}_{}'.format(
                            args.model,
                            args.data,
                            args.features,
                            args.seq_len,
                            ...
                            fix_seed[ii],
                            ii)
                    elif modelname == 'SCINet':
                        setting = '{}_{}_{}_sl{}_pl{}_CI{}_level{}_stack{}_seed{}_{}'.format(
                            args.model,
                            args.data,
                            args.features,
                            args.seq_len,
                            ...
                            fix_seed[ii],
                            ii)
                    elif modelname == 'LightTS':
                        setting = '{}_{}_{}_sl{}_pl{}_seed{}_{}'.format(
                            args.model,
                            args.data,
                            args.features,
                            args.seq_len,
